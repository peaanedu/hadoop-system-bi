...
The `https://github.com/peaanedu/hadoop-system-bi.git` directory holds all the essential pre-configured XML files for this single-node Hadoop and Hive setup.
...
cp SetUp/Hive/Hive_Config_Files/hive-site.xml /usr/local/hive/conf/
...
Select "ODBC" -> Connect -> hadoop-ecosystem-bi -> Ok
